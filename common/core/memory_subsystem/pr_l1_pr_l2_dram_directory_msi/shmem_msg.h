   ...
   class ShmemMsg
   {
      public:
         enum msg_t
         {
            ...
            // DRAM > tag directory
            DRAM_READ_REP,
            // LLC > NVM   // Added by Kleber Kruger to support NVM operations
            NVM_READ_REQ,  // Added by Kleber Kruger
            NVM_WRITE_REQ, // Added by Kleber Kruger
            NVM_LOG_REQ,   // Added by Kleber Kruger
