...
namespace ParametricDramDirectoryMSI
{
   ...
   class CacheMasterCntlr
   {
      private:
         ...
         friend class CacheCntlrNVOver; // Added by Kleber Kruger
   ...
   class CacheCntlr : ::CacheCntlr
   {
      protected: // Modified by Kleber Kruger (old value: private)
         ...
         // Added by Kleber Kruger (a wrapper to writeCacheBlock function)
      ...
      public:
         ...
         // Modified by Kleber Kruger (added virtual keyword)
         virtual HitWhere::where_t processMemOpFromCore(
         ...
         static char getCStateString(CacheState::cstate_t cstate); // Added by Kleber Kruger
