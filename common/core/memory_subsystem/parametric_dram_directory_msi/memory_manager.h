...
#include "overlay_mem_cntlr.h"      // Added by Kleber Kruger
#include "multi_snapshot_mapping.h" // Added by Kleber Kruger
...
namespace ParametricDramDirectoryMSI
{
   ...
   class MemoryManager : public MemoryManagerBase
   {
      private:
         ...
         bool m_nvm_cntlr_present;  // Added by Kleber Kruger
         ...
         // Added by Kleber Kruger (for NVOVerlay implementation)
         PrL1PrL2DramDirectoryMSI::MultiSnapshotNVMMapping* m_multisnap_map;
      ...
      public:
         ...
         // Added by Kleber Kruger (for NVOVerlay implementation)
         PrL1PrL2DramDirectoryMSI::MultiSnapshotNVMMapping* getMultiSnapMap() { return m_multisnap_map; }
